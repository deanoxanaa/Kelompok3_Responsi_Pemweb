  ...
  <body>
            ...
            <div class="container text-center">
                <div class="row">
                    <div class="col text-center">
                        <h2>Superior Room</h2>
                        <hr>
                        <p>Kamar Superior memiliki satu tempat tidur berukuran King dengan dua sofa permanen yang ideal digunakan untuk bersantai, atau bisa berfungsi sebagai 
                        tempat tidur tambahan</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- reservasi superior -->
        <div class="container">
            ...
            <div class="col-md-8">
                <div>
                    <img src="https://foverehotels.com//img_anekaweb/kamar/small_55smg-deluxe.jpg" class="card-img-top" alt="...">
                </div>
            </div>
            <div class="col-md-4">
                <!-- form pemesanan superior -->
