...
<body>
            ...
            <div class="container text-center">
                <div class="row">
                    <div class="col text-center">
                        <h2>Standard Room</h2>
                        <hr>
                        <p>Standar room adalah jenis kamar dengan fasilitas terendah atau sesuai dengan standar dari
                            hotel
                            yang menamainya demikian, hotel jenis ini adalah yang memiliki harga kamar terendah dengan
                            kamar
                            yang lainnya tetapi fasilitas yang ditawarkan sangat beragam</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
            ...
            <div class="col-md-8">
                <div>
                    <img src="https://foverehotels.com//img_anekaweb/kamar/small_71smg-superior.jpg" class="card-img-top" alt="...">
                </div>
            </div>
            <div class="col-md-4">
                <!-- form pemesanan standard -->
